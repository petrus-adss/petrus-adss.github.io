...
export default async function ForexMarketPage({ params }: PageProps) {
      ...
      <main className="flex-1 pt-16">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Master The Forex Market With ADSS</h1>
