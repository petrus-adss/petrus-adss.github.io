        ...
        <div className="max-w-[1340px] mx-[-15px]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="w-full md:w-1/2 px-0 md:px-4">
              ...
              {/* Description */}
              <div className="mt-6">
                <h5 className="text-white text-base md:text-lg leading-relaxed">
                  {description}{" "}
                  {termsLink && (
              ...
              {/* CTA Buttons */}
              <div className="mt-8 md:mt-12 flex flex-wrap gap-3 items-center">
                <Link
                  href={primaryCta.href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative inline-block mr-8 md:mr-[50px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#00FF00]"
                >
                ...
                {secondaryCta && (
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group inline-flex items-center gap-2 py-2 px-1 text-white font-normal mr-6 md:mr-[22px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#00FF00]"
                  >
                    {secondaryCta.text}
                    <span
            ...
            {/* Right Content - Trading Chart Image */}
            {chartImage && (
