...
interface HeaderRTLProps {
  locale?: string
}

export function HeaderRTL({ locale = "ar" }: HeaderRTLProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0D1821]" dir="rtl">
      <div className="container mx-auto px-4 max-w-[1340px] h-full">
        <div className="flex items-center justify-between h-20">
          {/* Logo - Right side for RTL */}
          <div className="flex-shrink-0 order-3 xl:order-1">
            <Link href={`/${locale}/`} aria-label="ADSS الرئيسية">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 166.63 71.51"
                className="h-10 w-auto"
                role="img"
                aria-labelledby="adssLogoTitleAr"
              >
                <title id="adssLogoTitleAr">شعار ADSS</title>
                <g fill="currentColor">
                  <path
                    id="Path_15"
                  ...
                  <path
                    id="Path_18"
                    className="logo_colour"
                    d="M137.73,39.06A11.26,11.26,0,0,0,135,35.33a14.44,14.44,0,0,0-3.8-2.47,27.75,27.75,0,0,0-4.37-1.48a21.06,21.06,0,0,1-5.9-2.13,3.76,3.76,0,0,1-2.14-3.34,2.79,2.79,0,0,1,.44-1.49,3.75,3.75,0,0,1,1.2-1.21,6.15,6.15,0,0,1,1.66-.83,6.5,6.5,0,0,1,1.91-.29,9.79,9.79,0,0,1,2.69.35,16.25,16.25,0,0,1,2.4.92,60.89,60.89,0,0,1,6.08,3.58,20.13,20.13,0,0,1,.56-4.77,16.44,16.44,0,0,1,1.14-3,5.51,5.51,0,0,0-.7-.75,14.65,14.65,0,0,0-2.71-1.83,19.23,19.23,0,0,0-4-1.51,20.69,20.69,0,0,0-5.38-.64,18.55,18.55,0,0,0-6.44,1,13.53,13.53,0,0,0-4.57,2.73,11.42,11.42,0,0,0-2.32,3.15,19,19,0,0,1,3.07,5.07A26.37,26.37,0,0,1,115.54,36c0,.25,0,.49,0,.77.12.06.2.14.32.2a19,19,0,0,0,4.2,1.58A29.2,29.2,0,0,1,126.86,41a3.88,3.88,0,0,1,2.18,3.5,3.67,3.67,0,0,1-.53,1.85,4.33,4.33,0,0,1-1.36,1.4,6.3,6.3,0,0,1-1.85.88,7,7,0,0,1-2,.3,11.27,11.27,0,0,1-3.26-.46,13.91,13.91,0,0,1-2.78-1.18,16,16,0,0,1-2.37-1.62c-.32-.27-.6-.54-.89-.82,0,.12-.08.27-.14.4a19.18,19.18,0,0,1-4.77,6.67L109,52c.31.28.61.55,1,.83A21.15,21.15,0,0,0,113.52,55,21.7,21.7,0,0,0,118,56.51a23.66,23.66,0,0,0,5.44.57,18.78,18.78,0,0,0,6-.94,15.3,15.3,0,0,0,4.85-2.65,12.81,12.81,0,0,0,3.24-4,10.67,10.67,0,0,0,1.2-5,13.15,13.15,0,0,0-1-5.4"
                  />
                  <path
                    id="Path_20"
          ...
          <nav className="hidden xl:flex items-center gap-8 order-2">
            <button
          ...
          {/* Left Side - Language & CTA */}
          <div className="flex items-center gap-3 order-1 xl:order-3">
            {/* Language Selector */}
            <div className="relative">
              ...
              {languageDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 bg-white rounded shadow-lg py-1 min-w-[140px] z-50">
                  <a
                    href={
                      typeof window !== "undefined" ? window.location.pathname.replace(`/${locale}/`, "/en/") : "/en/"
                    }
